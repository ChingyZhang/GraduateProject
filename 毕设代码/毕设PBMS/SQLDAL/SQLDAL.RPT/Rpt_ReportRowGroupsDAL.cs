...
{
	/// <summary>
	///Rpt_ReportRowGroups数据访问DAL类
	/// </summary>
	public class Rpt_ReportRowGroupsDAL : BaseSimpleDAL<Rpt_ReportRowGroups>
	{
		#region 构造函数
		///<summary>
		///
		///</summary>
		public Rpt_ReportRowGroupsDAL()
		{
			_ProcePrefix = "MCS_Reports.dbo.sp_Rpt_ReportRowGroups";
		}
		#endregion
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public override int Add(Rpt_ReportRowGroups m)
        {
			#region	设置参数集
            SqlParameter[] prams = {
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public override int Update(Rpt_ReportRowGroups m)
        {
			#region	设置参数集
            SqlParameter[] prams = {
				SQLDatabase.MakeInParam("@ID", SqlDbType.UniqueIdentifier, 16, m.ID),
        ...
        protected override Rpt_ReportRowGroups FillModel(IDataReader dr)
		{
			Rpt_ReportRowGroups m = new Rpt_ReportRowGroups();
