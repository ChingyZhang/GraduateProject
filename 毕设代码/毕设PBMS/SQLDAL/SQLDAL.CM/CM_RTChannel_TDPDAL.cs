...
{
	/// <summary>
	///CM_RTChannel_TDP数据访问DAL类
	/// </summary>
	public class CM_RTChannel_TDPDAL : BaseSimpleDAL<CM_RTChannel_TDP>
	{
		#region 构造函数
		///<summary>
		///
		///</summary>
		public CM_RTChannel_TDPDAL()
		{
			_ProcePrefix = "MCS_CM.dbo.sp_CM_RTChannel_TDP";
		}
		#endregion
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public override int Add(CM_RTChannel_TDP m)
        {
			#region	设置参数集
            SqlParameter[] prams = {
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public override int Update(CM_RTChannel_TDP m)
        {
			#region	设置参数集
            SqlParameter[] prams = {
        ...
        protected override CM_RTChannel_TDP FillModel(IDataReader dr)
		{
			CM_RTChannel_TDP m = new CM_RTChannel_TDP();
