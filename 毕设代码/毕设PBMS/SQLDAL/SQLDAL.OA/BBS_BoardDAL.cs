...
namespace MCSFramework.SQLDAL.OA
{
	...
	///BBS_Board数据访问DAL类
	/// </summary>
	public class BBS_BoardDAL : BaseSimpleDAL<BBS_Board>
	{
		#region 构造函数
		///<summary>
		///
		...
		public BBS_BoardDAL()
		{
			_ProcePrefix = "MCS_OA.dbo.sp_BBS_Board";
		}
		#endregion
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public override int Add(BBS_Board m)
        {
			#region	设置参数集
            SqlParameter[] prams = {
				...
				SQLDatabase.MakeInParam("@CanUplodAtt", SqlDbType.Char, 1, m.CanUplodAtt),
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public override int Update(BBS_Board m)
        {
			#region	设置参数集
            SqlParameter[] prams = {
        ...
        protected override BBS_Board FillModel(IDataReader dr)
		{
			BBS_Board m = new BBS_Board();
			...
			if (!string.IsNullOrEmpty(dr["CanUplodAtt"].ToString()))	m.CanUplodAtt = (string)dr["CanUplodAtt"];
        ...
        public int DeleteBoard(int id)
        {
            ...
            return SQLDatabase.RunProc(_ProcePrefix + "_DeleteBoard", prams);
        }
        public DataTable GetIndexInfo()
        {
            ...
            SQLDatabase.RunProc(_ProcePrefix + "_GetIndexInfo", out dr);
