    ...
    public class Addr_OfficialCityDAL : BaseSimpleDAL<Addr_OfficialCity>
    {
        ...
        public override int Add(Addr_OfficialCity m)
        {
            ...
            SqlParameter[] prams = {
                ...
                SQLDatabase.MakeInParam("@RegionalizationType",SqlDbType.Int,4,m.RegionalizationType)
			};
            #endregion
        ...
        protected override Addr_OfficialCity FillModel(IDataReader dr)
        {
            ...
            if (!string.IsNullOrEmpty(dr["RegionalizationType"].ToString())) m.RegionalizationType = (int)dr["RegionalizationType"];
            return m;
        }
        ...
        public static int GetOfficialCityRelate_V3(int officialCity)
        {
            #region	设置参数集
            SqlParameter[] prams = { 
                SQLDatabase.MakeInParam("@OfficialCityID",SqlDbType.Int,4,officialCity)
			};
            #endregion

            int ret = SQLDatabase.RunProc("sp_Addr_OfficialCity_GetRelate_V3", prams);
        ...
        public static int GetOfficialCityBy_V3ID(int Level,int V3_ID)
        {
            ...
            SqlParameter[] prams = { 
                ...
                SQLDatabase.MakeInParam("@V3_ID",SqlDbType.Int,4,V3_ID)
			};
            #endregion

            int ret = SQLDatabase.RunProc("sp_Addr_OfficialCity_GetOfficialCityBy_V3ID", prams);
