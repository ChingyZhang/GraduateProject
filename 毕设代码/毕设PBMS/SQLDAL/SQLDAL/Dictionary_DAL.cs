...
namespace MCSFramework.SQLDAL
{
    public class Dictionary_DAL : BaseSimpleDAL<Dictionary_Data>
    {
        ...
        protected override SqlParameterDictionary GetParamsCollection(Dictionary_Data m)
        {
            ...
            p.Add("InsertUser", SQLDatabase.MakeInParam("@InsertUser", SqlDbType.NVarChar, 256, m.InsertUser));
            p.Add("UpdateTime", SQLDatabase.MakeInParam("@UpdateTime", SqlDbType.DateTime, 8, m.UpdateTime));
            p.Add("UpdateUser", SQLDatabase.MakeInParam("@UpdateUser", SqlDbType.NVarChar, 256, m.UpdateUser));
        ...
        protected override Dictionary_Data FillModel(IDataReader dr)
        {
            ...
            if (!string.IsNullOrEmpty(dr["InsertUser"].ToString())) m.InsertUser = (string)dr["InsertUser"];
            if (!string.IsNullOrEmpty(dr["UpdateTime"].ToString())) m.UpdateTime = (DateTime)dr["UpdateTime"];
            if (!string.IsNullOrEmpty(dr["UpdateUser"].ToString())) m.UpdateUser = (string)dr["UpdateUser"];
