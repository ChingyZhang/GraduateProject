...
namespace MCSFramework.BLL
{
    public abstract class BaseSimpleBLL<T> : ISimpleBll<T>
    {
        ...
        private int keytype = 1;    //主键类型 1:int 2:guid 3:string 4:long
        ...
        protected void FillModel(long id)
        {
            FillModel(id, false);
        }
        /// <summary>
        ...
        /// <param name="id"></param>
        /// <param name="bycache"></param>
        protected void FillModel(long id, bool bycache)
        {
            keytype = 4;
            _lid = id;
