...
{
	/// <summary>
	///INV_ReportedLoss数据实体类
	/// </summary>
	[Serializable]
	public class INV_ReportedLoss : IModel
	{
		#region 私有变量定义
		private int _id = 0;
		...
		///
		///</summary>
		public INV_ReportedLoss(int id, string sheetcode, int warehouse, int relatedeliveryid, int classify, string reason, DateTime confirmtime, Guid confirmuser, string remark, int approvetask, int approveflag, DateTime inserttime, Guid insertuser, DateTime updatetime, Guid updateuser)
		{
			_id               = id;
