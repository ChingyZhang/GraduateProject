...
{
	/// <summary>
	///Rpt_ReportRowGroups数据实体类
	/// </summary>
	[Serializable]
	public class Rpt_ReportRowGroups : IModel
	{
		#region 私有变量定义
		...
		///
		///</summary>
		public Rpt_ReportRowGroups(Guid id, Guid report, Guid datasetfield, string displayname, int groupsortid, string addsummary, DateTime inserttime, DateTime updatetime)
		{
			_id           = id;
			_report       = report;
        ...
        {
            get { return "Rpt_ReportRowGroups"; }
        }
		#region 索引器访问
