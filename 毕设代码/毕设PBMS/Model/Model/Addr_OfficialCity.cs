...
namespace MCSFramework.Model
{
    ...
    public class Addr_OfficialCity : IModel
    {
        ...
        private int _regionalizationType = 0;
        #endregion
        ...
        ///
        ///</summary>
        public Addr_OfficialCity(int id, string name, int superid, int level, string code, string callareacode, string postcode, int births, int attribute, int regionalizationType)
        {
            _id = id;
            _name = name;
            _superid = superid;
            ...
            _regionalizationType = regionalizationType;
        }
        #endregion
        ...
        public int RegionalizationType
        {
            get
            {
                return _regionalizationType;
            }
            set
            {
                _regionalizationType = value;
            }
        }
        #endregion
        ...
        public string this[string FieldName]
        {
            get
            {
                switch (FieldName)
                {
                    ...
                    case "RegionalizationType":
                        return _regionalizationType.ToString();
            ...
            set
            {
                switch (FieldName)
                {
                    ...
                    case "Attribute":
                        ...
                        break;
                    case "RegionalizationType":
                        int.TryParse(value, out _regionalizationType);
                        break;
                }
            }
        }
