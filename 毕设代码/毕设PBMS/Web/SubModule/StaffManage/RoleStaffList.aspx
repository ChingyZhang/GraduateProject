<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoleStaffList.aspx.cs" Inherits="SubModule_StaffManage_RoleInfo"
    MasterPageFile="~/MasterPage/BasicMasterPage.master" %>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0" class="tabForm">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:Button ID="bt_In" runat="server" OnClick="bt_In_Click" Text="加入角色" Enabled="False" />
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("aspnet_Membership_StaffID", "StaffDetail.aspx?ID={0}") %>'
                                                                    Target="_blank" Text="员工详细资料" Visible='<%# Eval("aspnet_Membership_StaffID").ToString()!="" %>'></asp:HyperLink>
                                                            </ItemTemplate>
