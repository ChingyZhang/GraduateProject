                    ...
                    <td class="tabForm">
                        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                            ...
                            <tr>
                                ...
                                <td class="dataField">
                                    <asp:TextBox ID="tbx_BeginDate" Width="120px" runat="server" onfocus="WdatePicker()"></asp:TextBox><span
                                ...
                                <td class="dataField">
                                    <asp:TextBox ID="tbx_EndDate" Width="120px" runat="server" onfocus="WdatePicker()"></asp:TextBox><span
