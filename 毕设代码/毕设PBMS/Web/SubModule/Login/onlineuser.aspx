<%@ Page Language="c#" Inherits="OnlineUser" CodeFile="onlineuser.aspx.cs" StylesheetTheme="basic" %>
...
<body  leftmargin="0" topmargin="0" style="background-image:none;background-color:#ff9d9d">
        ...
        <ContentTemplate>
            <div align="center">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" class="">
                    <tr>
                        <td>
                            <a href="javascript:showonlineuser()"></a>
                                <asp:Image ID="Image6" runat="server" ImageUrl="~/Images/Icon/07.gif" Width="18px" />
                        </td>
