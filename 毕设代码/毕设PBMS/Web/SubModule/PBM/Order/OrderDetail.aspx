<%@ Page Language="C#" MasterPageFile="~/MasterPage/BasicMasterPage.master" AutoEventWireup="true"
    CodeFile="OrderDetail.aspx.cs" Inherits="SubModule_PBM_Order_OrderDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript" language="javascript">
        function Pop_Assign() {
            window.showModalDialog('Pop_Order_Assign.aspx', window, 'dialogWidth:500px;DialogHeight=260px;status:yes;resizable=yes');
        }
    </script>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" class="moduleTitle">
                            <tr>
                                ...
                                <td align="right">&nbsp;
                                    ...
                                    <asp:Button ID="bt_Delete" runat="server" Height="23px" OnClick="bt_Delete_Click" OnClientClick="return confirm('是否确认删除该订单?');" Text="删除" Width="60px" />
                                    <asp:Button ID="bt_Cancel" runat="server" Width="60px" OnClientClick="return confirm('是否确认取消该订单?');" Text="取消" OnClick="bt_Cancel_Click" />
                                    <asp:Button ID="bt_Submit" runat="server" OnClick="bt_Submit_Click" OnClientClick="return confirm('是否确认提交该订单?');" Text="提交" Width="60px" />
                                    <asp:Button ID="bt_Assign" runat="server" OnClick="bt_Assign_Click" OnClientClick="Pop_Assign()" Text="派单" Width="60px" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="UpdatePanel_Detail" runat="server" ChildrenAsTriggers="true" RenderMode="Inline">
                    <ContentTemplate>
                        <mcs:UC_DetailView ID="pl_detail" runat="server" DetailViewCode="DV_PBM_Order_OrderDetail_01">
                        </mcs:UC_DetailView>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        <td class="tabForm">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    <td class="dataLabel" height="28" width="80">收款方式一</td>
                                    <td class="dataField">
                                    ...
                                    <td class="dataLabel" width="80">收款金额</td>
                                    <td class="dataField">
                                        <asp:TextBox ID="tbx_PayAmount1" runat="server">0</asp:TextBox>元
                                    ...
                                    <td class="dataLabel" height="28" width="80">收款方式二</td>
                                    <td class="dataField">
                                    ...
                                    <td class="dataLabel" width="80">收款金额</td>
                                    <td class="dataField">
                                        <asp:TextBox ID="tbx_PayAmount2" runat="server">0</asp:TextBox>元
                                    ...
                                    <td class="tabForm">
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0" runat="server" id="tb_AddDetail">
                                            <tr>
                                                ...
                                                <td align="left" style="padding-left: 10px">销售单价</td>
                                                ...
                                                <td class="dataLabel">
                                                    <mcs:MCSSelectControl ID="select_Product" runat="server" OnSelectChange="select_Product_SelectChange" PageUrl="~/SubModule/PBM/Product/Pop_Search_Product_TDP.aspx" Width="260px" OnTextChange="select_Product_TextChange" TextBoxEnabled="True" />
                                                     <%--<telerik:RadComboBox ID="RadComboBox1" runat="server" AllowCustomText="false" Width="250px"  DataTextField="FullName" DataValueField="ID"  HighlightTemplatedItems="true" Filter="Contains"
                                                         DropDownAutoWidth="Disabled" NoWrap="true" EmptyMessage="请选择一个产品..." AutoPostBack="True" OnSelectedIndexChanged="RadComboBox1_SelectedIndexChanged" MarkFirstMatch="true" DropDownWidth="550px">
                                                        <HeaderTemplate>
                                                              <table>
                                                                  <tr>
                                    ...
                                    <td>
                                        <mcs:UC_GridView ID="gv_List" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="销售价" SortExpression="Price">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lb_Price" runat="server" Text='<%# Bind("Price", "{0:0.###}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="数量" SortExpression="BookQuantity">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="金额">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lb_Fee" runat="server" Text='<%# (((int)Eval("BookQuantity") * Math.Round((decimal)Eval("Price") * (int)Eval("ConvertFactor"), 2)/(int)Eval("ConvertFactor")).ToString("0.##")) %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="SalesMode" HeaderText="标志" SortExpression="SalesMode" />
                                                <asp:TemplateField HeaderText="总库存数量">
                                                    <ItemTemplate>
