<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferDetail_Print.aspx.cs" Inherits="SubModule_PBM_Delivery_Transfer_TransferDetail_Print" %>
                    ...
                    <ItemTemplate>
                        ...
                        <div id="diva" style="text-align: left; width: 241mm; height: 93mm; margin: 0px auto;">
                            ...
                            <table style="width: 95%; margin: 0px auto;">
                                    ...
                                    <td>打印日期：<%= System.DateTime.Now.ToString("yyyy-MM-dd") %>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                ...
                                                <%--                                                <td align="center"><span class="PageTitle2">
                                                    <asp:Literal ID="Literal1" runat="server" Text="无"></asp:Literal></span>
                                                </td>--%>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table class="spanRow" style="height: 30px;" cellspacing="2" cellpadding="0" width="100%" border="0">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">出库仓库：<asp:Label ID="lbSupplierWareHouse" runat="server" Text="无"></asp:Label></td>
                                    ...
                                    <td>
                                        <mcs:UC_GridView ID="gv_List" runat="server" Width="100%" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="产品名称" ItemStyle-Width="300px">
                                                    <ItemTemplate>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" cellpadding="5" border="1" cellspacing="0" bordercolordark="#ffffff" bordercolorlight="#666666" style="border-collapse: collapse; height: 30px;">
                                            <tr style="font-weight: bold;" runat="server" id="tr_TotalInfo">
                                                ...
                                                <td width="100px" colspan="2">金额&nbsp;<asp:Label ID="lbTotalCost" runat="server" Text="301.4"></asp:Label>
                                                </td>
                                            ...
                                            <tr height="25px">
                                                ...
                                                <td width="50%">库管&nbsp;<asp:Label ID="Label7" runat="server" Text=""></asp:Label>
                                                </td>
