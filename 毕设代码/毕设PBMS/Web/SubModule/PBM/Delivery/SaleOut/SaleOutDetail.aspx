<%@ Page Language="C#" MasterPageFile="~/MasterPage/BasicMasterPage.master" AutoEventWireup="true"
    CodeFile="SaleOutDetail.aspx.cs" Inherits="SubModule_PBM_Delivery_SaleOut_SaleOutDetail" %>
<%--<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>--%>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        function doprint(id) {
            window.open("SaleOutDetail_Print.aspx?ID=" + id);
        }
    </script>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" class="moduleTitle">
                            <tr>
                                ...
                                <td nowrap="noWrap" style="width: 180px">
                                    <h2>
                                        <asp:Label ID="lb_PageTitle" runat="server" Text="销售单详细信息"></asp:Label></h2>
                                </td>
                                <td align="right">&nbsp;
                                    <asp:Button ID="bt_OK" runat="server" Width="60px" Text="保存" OnClick="bt_OK_Click" />
                                    <asp:Button ID="bt_Cancel" runat="server" Width="60px" Text="取消" OnClick="bt_Cancel_Click" OnClientClick="return confirm('是否确认取消该单据?');"/>
                                    ...
                                    <asp:Button ID="bt_Confirm" runat="server" OnClick="bt_Confirm_Click" OnClientClick="return confirm('是否确认完成该送货单?');" Text="审核" Width="60px" />
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="UpdatePanel_Detail" runat="server" ChildrenAsTriggers="true" RenderMode="Inline">
                    <ContentTemplate>
                        <mcs:UC_DetailView ID="pl_detail" runat="server" DetailViewCode="DV_PBM_Delivery_SaleOutDetail_01">
                        </mcs:UC_DetailView>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
                                ...
                                <tr>
                                    ...
                                    <td class="dataField">
                                        <asp:DropDownList ID="ddl_PayMode1" runat="server">
                                            ...
                                            <asp:ListItem Value="12">记应收</asp:ListItem>
                                        </asp:DropDownList></td>
                                    ...
                                    <td class="dataField">
                                        <asp:DropDownList ID="ddl_PayMode2" runat="server">
                                            ...
                                            <asp:ListItem Value="2">POS</asp:ListItem>
                                            <asp:ListItem Value="11">余额付款</asp:ListItem>
                                            <asp:ListItem Selected="True" Value="12">记应收</asp:ListItem>
                                        </asp:DropDownList></td>
                                    <td class="dataLabel" width="80">收款金额</td>
                                    <td class="dataField">
                                    ...
                                    <td class="tabForm">
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0" runat="server" id="tb_AddDetail">
                                            ...
                                            <tr>
                                                ...
                                                <td class="dataLabel">
                                                    <asp:Label ID="lb_ProductDate" runat="server"></asp:Label>                                                    
                                                </td>
                                                <td class="dataLabel">
                                                ...
                                                <td class="dataLabel">
                                                    ...
                                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="tbx_Price" Display="Dynamic" ErrorMessage="必需是数字格式" Operator="DataTypeCheck" Type="Double" ValidationGroup="bt_SaveDetail"></asp:CompareValidator>
                                                </td>
                                                <td class="dataLabel">
                                    ...
                                    <td>
                                        <mcs:UC_GridView ID="gv_List" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="数量" SortExpression="SignInQuantity">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="金额">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lb_Fee" runat="server" Text='<%# (((int)Eval("SignInQuantity") * Math.Round((decimal)Eval("Price") * (int)Eval("ConvertFactor"), 2)/(int)Eval("ConvertFactor")).ToString("0.##元")) %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
