<%@ Page Language="C#" MasterPageFile="~/MasterPage/BasicMasterPage.master" AutoEventWireup="true"
    CodeFile="PurchaseList.aspx.cs" Inherits="SubModule_PBM_Delivery_Purchase_PurchaseList" %>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0" class="moduleTitle">
                    <tr>
                        ...
                        <td nowrap="noWrap" style="width: 180px">
                            <h2>
                                <asp:Label ID="lb_PageTitle" runat="server" Text="采购单列表"></asp:Label></h2>
                        </td>
                    ...
                    <ContentTemplate>
                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tr>
                                ...
                                <td class="dataLabel">供货商
                                </td>
                                <td class="dataField">
                                    <asp:DropDownList ID="ddl_Supplier" runat="server" DataTextField="FullName" DataValueField="ID"></asp:DropDownList></td>
                                </td>
                                ...
                                <td class="dataField">
                                    <asp:DropDownList ID="ddl_Classify" runat="server" DataTextField="Name" DataValueField="ID" Width="200px">
                                        ...
                                        <asp:ListItem Value="11" Text="采购入库单"></asp:ListItem>
                                        <asp:ListItem Value="12" Text="采购退库单"></asp:ListItem>
                                        <asp:ListItem Value="14" Text="市场物品入库单"></asp:ListItem>
                                    </asp:DropDownList></td>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="dataField">
                                    <asp:DropDownList ID="ddl_State" runat="server" DataTextField="Value" DataValueField="Key">
                                        ...
                                        <asp:ListItem Value="3" Text="在途"></asp:ListItem>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel_List" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <mcs:UC_GridView ID="gv_List" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        PanelCode="Panel_PBM_Delivery_PurchaseList_01">
                                        <Columns>
                                            <asp:HyperLinkField DataNavigateUrlFields="PBM_Delivery_ID" DataNavigateUrlFormatString="PurchaseDetail.aspx?ID={0}"
