...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr class="tabForm">
            <td>
                <table cellspacing="3" cellpadding="3" width="100%" height="500" align="center" border="0">
                    <tr>
                        <td valign="top" width="340px" style="border-right-style: solid; border-right-width: 1px; border-right-color: #C0C0C0;" runat="server" visible="false">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                            <ContentTemplate>
                                                <table id="tbl_NewKB" runat="server" cellspacing="0" cellpadding="0" width="100%"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table class="h3Row" cellspacing="0" cellpadding="0" width="100%" border="0" style="border-top-style: solid; border-top-width: 1px; border-top-color: #C0C0C0;">
                                                                <tr>
                                                                    <td width="32px">
                                                                    ...
                                                                    <td align="right">
                                                                        <a href="OA/KB/index.aspx" target="_blank">
                                                                                    ...
                                                                                    <asp:TemplateField>
                                                                                        <ItemTemplate>
                                                                                            <asp:HyperLink ID="hy_KB" runat="server" NavigateUrl='<%# Eval("ID", "OA/KB/ArticleDetail.aspx?ID={0}") %>'
                                                                                                Target="_blank" Text='<%# Eval("Title") %>' CssClass="listViewTdLinkS1"></asp:HyperLink>
                                                                                            <br />
                                                    ...
                                                    <tr valign="top">
                                                        <td>
                                                            <mcs:UC_GridView ID="gv_ReplyLatest" runat="server" Width="100%" AutoGenerateColumns="false"
                                                                ...
                                                                <Columns>
                                                                    <asp:HyperLinkField DataNavigateUrlFields="ID,Board" Target="_blank" DataNavigateUrlFormatString="~/SubModule/OA/BBS/display.aspx?ID={0}&BoardID={1}"
                        ...
                        <td align="left" valign="top" width="800px" style="border-right-style: solid; border-right-width: 1px; border-right-color: #C0C0C0;">
                                                        ...
                                                        <td>
                                                            <mcs:UC_GridView ID="gv_TodayTask" runat="server" Width="100%" AutoGenerateColumns="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:HyperLinkField DataNavigateUrlFields="TaskUri" Target="_blank" Text="查看" ControlStyle-CssClass="listViewTdLinkS1"></asp:HyperLinkField>
                                                                </Columns>
                                                            </mcs:UC_GridView>
                                                        </td>
                                                    </tr>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("ID", "~/SubModule/OA/PN/read.aspx?ID={0}") %>'
                                                                                Target="_blank" Text='<%# (DataBinder.Eval(Container,"DataItem[\"Catalog\"]")!=""?("["+MCSFramework.BLL.DictionaryBLL.GetDicCollections("OA_NoticeCatalog")[DataBinder.Eval(Container,"DataItem[\"Catalog\"]").ToString()]+"]"):"")+Eval("Topic") %>' CssClass="listViewTdLinkS1"></asp:HyperLink>
                                                                            <br />
                                                                                ...
                                                                                <asp:TemplateField>
                                                                                    <ItemTemplate>
                                                                                        <a href="EWF/InviteConsultDetail.aspx?InviteConsult=<%# DataBinder.Eval(Container.DataItem, "ID")%>&TaskID=<%# DataBinder.Eval(Container.DataItem,"TaskID")%>"
                                                                                            class="listViewTdLinkS1" target="_blank">回复邀审</a>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                                        </mcs:UC_GridView>
