...
{
    public partial class DownOrganizeCityTargetTemp : Form
    {
        public string path;
        public DownOrganizeCityTargetTemp()
        {
            InitializeComponent();
        ...
        {
            string fileName = string.Format("{0}{1}记录", DateTime.Now.Date.ToString("yyyyMMdd"), "办事处业绩目标额模版");                                                  // 设置默认的保存文件名
