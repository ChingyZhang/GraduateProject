...
namespace MCSFramework.SQLDAL.Pub
{
    ...
    public class ATMT_AttachmentDAL : BaseSimpleDAL<ATMT_Attachment>
    {
        ...
        public int UploadData(Guid guid, byte[] filedata)
        {
            ...
            return SQLDatabase.RunProc("MCS_ATMT_ConnectionString", "sp_ATMT_FileData_UploadData", prams);
        }
        ...
        public int UploadThumbnailData(Guid guid, byte[] thumbnaildata)
        {
            ...
            return SQLDatabase.RunProc("MCS_ATMT_ConnectionString", "sp_ATMT_FileData_UploadThumbnailData", prams);
        }
        ...
        public int DeleteData(Guid guid)
        {
            ...
            return SQLDatabase.RunProc("MCS_ATMT_ConnectionString", "sp_ATMT_FileData_Delete", prams);
        }
        ...
        public byte[] GetData(Guid guid)
        {
            ...
            SQLDatabase.RunProc("MCS_ATMT_ConnectionString", "sp_ATMT_FileData_GetModel", prams, out dr);
        ...
        public DataTable GetCKEditUploadDate(string UploadUser, bool OnlyImageFlag)
        {
            ...
            SQLDatabase.RunProc(_ProcePrefix + "_GetCKeditUploadDate", prams, out dr);
