<%@ page language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_CM_DI_SubClientList, App_Web_w-mwiuzz" enableEventValidation="false" stylesheettheme="basic" %>
                            ...
                            <tr>
                                ...
                                <td width="220px">
                                    <asp:RadioButtonList ID="rbl_SupplierMode" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rbl_SupplierMode_SelectedIndexChanged"
                                        ...
                                        <asp:ListItem Selected="True" Value="1">配送成品门店</asp:ListItem>
                                        <asp:ListItem Value="2">配送赠品门店</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                                <td>
                                    快捷查询
