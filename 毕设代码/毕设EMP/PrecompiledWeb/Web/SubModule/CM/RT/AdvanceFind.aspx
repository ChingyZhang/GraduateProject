<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_CM_RT_AdvanceFind, App_Web_hv25c18v" enableEventValidation="false" stylesheettheme="basic" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
        ...
        <tr class="tabForm" runat="server" id="tr_AdvancedSearch">
            <td>
                <uc1:AdvancedSearch ID="AdvancedSearch1" runat="server" PanelCode="Panel_RT_AdvanceFind"
                    ExtCondition="MCS_CM.dbo.CM_Client.ClientType=3" OnSelectedChanging="AdvancedSearch1_OnSelectedChanging" />
            </td>
        </tr>
    </table>
</asp:Content>
