<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_OA_BBS_BoardManage, App_Web_3-csmuv_" enableEventValidation="false" stylesheettheme="basic" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <table cellspacing="0" cellpadding="0" width="100%" border="0" class="moduleTitle">
          ...
          <tr>
            <td>
                <mcs:UC_DetailView ID="UC_Board" runat="server" DetailViewCode="Page_BBS_BoardDetail" 
                    Visible="true">
                </mcs:UC_DetailView> 
