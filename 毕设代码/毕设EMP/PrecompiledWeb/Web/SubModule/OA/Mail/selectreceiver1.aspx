<%@ page language="C#" autoeventwireup="true" inherits="SubModule_OA_Mail_selectreceiver1, App_Web_siz_p2qv" enableEventValidation="false" stylesheettheme="basic" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <asp:DropDownList ID="tr_Position" runat="server" AutoPostBack="true" Style="z-index: 111;
                left: 72px; position: absolute; top: 18px; right: 732px;" DataTextField="Name"
