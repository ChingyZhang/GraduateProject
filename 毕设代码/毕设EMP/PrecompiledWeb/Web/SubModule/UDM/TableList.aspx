<%@ page language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_UDM_TableList, App_Web_bl88rr1i" enableEventValidation="false" stylesheettheme="basic" %>
                            ...
                            <mcs:UC_GridView ID="gv_List" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="ModelFieldList.aspx?TableID={0}"
                                        Text="表字段列表" ControlStyle-CssClass="listViewTdLinkS1"  />
                                </Columns>
                            </mcs:UC_GridView>
                        </td>
                    </tr>
