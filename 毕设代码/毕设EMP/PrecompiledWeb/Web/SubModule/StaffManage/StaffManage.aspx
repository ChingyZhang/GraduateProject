                    ...
                    <td>
                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tr>
                                ...
                                <td>
                                 <asp:CheckBox ID="chb_IsDI" runat="server" Text="是否经销商账户" />
                                </td>
                                <td align="right">
                        ...
                        <mcs:UC_GridView ID="ud_grid" runat="server" PanelCode="Panel_Staff_List" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="Org_Staff_ID"  DataNavigateUrlFormatString="StaffDetail.aspx?ID={0}"
                                    DataTextField="Org_Staff_RealName" ControlStyle-CssClass="listViewTdLinkS1" HeaderText="名称">
                                    <ControlStyle CssClass="listViewTdLinkS1" />
                                </asp:HyperLinkField>
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="view" runat="server" NavigateUrl='<%# Bind("Org_Staff_ID","StaffDetail.aspx?ID={0}")%>'
                                            Text="照片管理" CssClass="listViewTdLinkS1"  ImageUrl='<%# MCSFramework.BLL.Pub.ATMT_AttachmentBLL.GetFirstPreviewPicture(10,(int)DataBinder.Eval(Container,"DataItem.Org_Staff_ID"))%>'>
                                        </asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
