<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_StaffManage_StaffDetail, App_Web_it73ecr1" enableEventValidation="false" stylesheettheme="basic" %>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <asp:Button ID="bt_TaskDetail" runat="server" Text="审批记录" Width="60px" OnClick="bt_TaskDetail_Click"
                                Visible="false" />
                            <asp:Button ID="bt_Print" runat="server" Text="打印" Width="47px" OnClick="bt_Print_Click" />
                            <asp:Button ID="bt_RevocationApply" runat="server" Text="发起离职审批" OnClick="bt_RevocationApply_Click" />
                        </td>
                    </tr>
                </table>
            </td>
