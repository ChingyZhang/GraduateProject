<%@ page language="C#" autoeventwireup="true" inherits="SubModule_Service_QNA_QNA_DisplayResult, App_Web_pltcgdyp" enableEventValidation="false" stylesheettheme="basic" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>显示问卷调研结果</title>
    <base target="_self">
    </base>
    <style type="text/css">
        .style1
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" border="0" class="moduleTitle">
                                <tr>
                                    ...
                                    <td nowrap="noWrap" style="width: 180px">
                                        <h2>
                                            <asp:Label ID="lb_PageTitle" runat="server" Text="显示问卷调研结果"></asp:Label></h2>
                                    </td>
                                    <td align="right">
                                        &nbsp;
                                    </td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:RadioButtonList ID="rbl_Result" runat="server" DataTextField="OptionName" DataValueField="ID"
                                                RepeatColumns="4" RepeatDirection="Horizontal" Visible="False" Enabled="true"
                                                AutoPostBack="true" OnSelectedIndexChanged="rbl_Result_SelectedIndexChanged">
                                            </asp:RadioButtonList>
                                            <asp:CheckBoxList ID="cbl_Result" runat="server" DataTextField="OptionName" DataValueField="ID"
                                                RepeatColumns="4" RepeatDirection="Horizontal" Visible="False" Enabled="true"
                                                AutoPostBack="True" OnSelectedIndexChanged="cbl_Result_SelectedIndexChanged">
                                            </asp:CheckBoxList>
                                            <asp:TextBox ID="tbx_Result" runat="server" Visible="False" Width="300px" ReadOnly="true"></asp:TextBox>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <SeparatorTemplate>
