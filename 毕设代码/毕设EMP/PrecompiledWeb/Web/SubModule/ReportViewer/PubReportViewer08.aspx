<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_ReportViewer_PubReportViewer08, App_Web_so7fogna" enableEventValidation="false" stylesheettheme="basic" %>
            ...
            <td>
                <table cellspacing="0" cellpadding="0" width="100%" border="0" id="Table2" class="moduleTitle"
                    ...
                    <tr>
                        ...
                        <td>
                            会计月:<asp:DropDownList ID="ddl_BeginMonth" runat="server" DataTextField="Name" DataValueField="ID">
                            </asp:DropDownList>
