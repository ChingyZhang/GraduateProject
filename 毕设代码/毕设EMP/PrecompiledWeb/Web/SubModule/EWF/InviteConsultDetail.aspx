<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_EWF_InviteConsultDetail, App_Web_8sm6e0fs" enableEventValidation="false" stylesheettheme="basic" %>
                                ...
                                <tr>
                                    ...
                                    <td height="18" align="right">
                                        <asp:Button ID="bt_SaveDecisionComment" runat="server" ForeColor="#990000" OnClick="bt_SaveDecisionComment_Click"
                                            Text="回复批复意见" ValidationGroup="Decision" />
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="left" width="100" height="18" class="dataLabel">
