<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_EWF_FlowProcessGetOrganizeCityDetail, App_Web_8sm6e0fs" enableEventValidation="false" stylesheettheme="basic" %>
                    ...
                    <td class="tabForm" width="100%">
                        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                            ...
                            <tr>
                                ...
                                <td class="dataField">
                                    <asp:DropDownList ID="ddl_OrganizeCityLevel" runat="server" DataTextField="Value"
                                        DataValueField="Key">
                                    </asp:DropDownList>
                                </td>
                                <td class="dataLabel" style="width: 120px; height: 30px;">
                                ...
                                <td class="dataField">
                                    <asp:DropDownList ID="ddl_DataObject_OrganizeCityID" DataTextField="DisplayName"
                                ...
                                <td class="dataField">
                                    <asp:DropDownList ID="ddl_DataObject_OrganizeCityName" DataTextField="DisplayName"
                                        DataValueField="ID" runat="server">
                                    </asp:DropDownList>
                                </td>
                            </tr>
