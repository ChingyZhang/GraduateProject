<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_FNA_FeeApply_FeeApply_CLContract, App_Web_5zp237uh" enableEventValidation="false" stylesheettheme="basic" %>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="50%" height="100">
                            <tr>
                                ...
                                <td class="dataField" align="left">
                                    <asp:DropDownList ID="ddl_Month" runat="server" DataTextField="Name" DataValueField="ID" Enabled="false" >
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="dataField" align="left">
                                    <asp:RadioButtonList ID="rbl_IsNKA" runat="server" RepeatDirection="Horizontal">
                                        <asp:ListItem Selected="True" Value="2">非KA</asp:ListItem>
                            ...
                            <tr>
                                <td align="center" colspan="2" height="22px">
                                    <asp:Button ID="bt_Generate" runat="server" Text="生成申请单" Width="80px" OnClick="bt_Generate_Click"
                                        OnClientClick="return confirm(&quot;请确认所有需要申请费用的陈列协议均已批复通过！&quot;)" />
                                </td>
                            </tr>                            
                        </table>
                    </ContentTemplate>
