<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_FNA_FeeApply_ApplySummary_GetRTChannelFLFee, App_Web_xopz9zty" enableEventValidation="false" stylesheettheme="basic" %>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="dataField" nowrap="nowrap">
                            ...
                            <asp:TextBox ID="txt_FeeRate" runat="server" Width="76px" Text="0"></asp:TextBox>%
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <td align="left">
                                        <mcs:MCSTabControl ID="MCSTabControl1" runat="server" Width="100%" SelectedIndex="2"
                                            ...
                                            <Items>
                                                ...
                                                <mcs:MCSTabItem Text="返利费用明细" Value="2" Enable="false" />
                                ...
                                <tr class="tabForm">
                                    <td>
                                        <mcs:UC_GridView ID="gv_List" runat="server" Width="96%" 
                                            OnDataBound="gv_List_DataBound" GridLines="Both" CellPadding="1" BackColor="#BBBBBB"
                                            CellSpacing="1" CssClass="" BorderWidth="0px" AllowPaging="true" PageSize="50"
