<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_FNA_StaffSalary_StaffSalaryDataObjectBetaList, App_Web_llmqckq0" enableEventValidation="false" stylesheettheme="basic" %>
                    ...
                    <ContentTemplate>
                        <mcs:MCSTabControl ID="MCSTabControl1" runat="server" Width="100%" OnOnTabClicked="MCSTabControl1_OnTabClicked"
                            ...
                            <Items>
                                ...
                                <mcs:MCSTabItem Text="业代目标" Value="2" ToolTip="先审核办事处主任再调整业代" />
                            </Items>
                        </mcs:MCSTabControl>
                    </ContentTemplate>
                    <Triggers>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <mcs:UC_GridView ID="gv_List" runat="server" Width="100%" AutoGenerateColumns="False"
                                AllowPaging="True" DataKeyNames="FNA_StaffSalaryDataObjectBeta_ID" PageSize="20"
                                AllowSorting="true" OrderFields="FNA_StaffSalaryDataObjectBeta_OrganizeCity1,FNA_StaffSalaryDataObjectBeta_OrganizeCity3,FNA_StaffSalaryDataObjectBeta_OrganizeCity4"
                                PanelCode="Panel_FNA_StaffSalaryDataObjectBeta" Binded="False">
                                <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="是否执行<br/>生成绩效">
                                        <ItemTemplate>
                                            <asp:DropDownList runat="server" ID="ddl_Flag" SelectedValue='<%# DataBinder.Eval(Container.DataItem,"FNA_StaffSalaryDataObjectBeta_Flag").ToString()%>'
                                                Width="60px" ToolTip="是否执行浮动底薪" Enabled='<%# DataBinder.Eval(Container.DataItem,"FNA_StaffSalaryDataObjectBeta_ApproveFlag").ToString()!="已审核" %>'>
                                    ...
                                    <asp:TemplateField HeaderText="备注">
                                        <ItemTemplate>
                                            <asp:TextBox ID="tbx_Remark" runat="server" Text='<%# Bind("FNA_StaffSalaryDataObjectBeta_Remark") %>'
                                                Enabled='<%# DataBinder.Eval(Container.DataItem,"FNA_StaffSalaryDataObjectBeta_ApproveFlag").ToString()!="已审核" %>'
                                    ...
                                    <asp:TemplateField HeaderText="业绩目标">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_SalesTarget" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"FNA_StaffSalaryDataObjectBeta_SalesTarget") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="总销售目标调整比例%">
                                        <ItemTemplate>
                                            <asp:TextBox ID="tbx_SalesTargetAdujstRate" runat="server" Text='<%# Bind("FNA_StaffSalaryDataObjectBeta_Data08","{0:0.###}") %>'
                                    ...
                                    <asp:TemplateField HeaderText="总销售目标调整金额">
                                        <ItemTemplate>
                                            <asp:TextBox ID="tbx_SalesTargetAdujst" runat="server" Text='<%# Bind("FNA_StaffSalaryDataObjectBeta_SalesTargetAdjust","{0:0.###}") %>'
                                                Enabled='<%# DataBinder.Eval(Container.DataItem,"FNA_StaffSalaryDataObjectBeta_ApproveFlag").ToString()!="已审核" %>'
