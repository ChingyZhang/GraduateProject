<%@ page language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_Login_UserDetail, App_Web_atkk77yx" enableEventValidation="false" stylesheettheme="basic" %>
                                ...
                                <td>
                                    ...
                                    <table width="100%" class="tabForm">
                                        ...
                                        <tr>
                                            ...
                                            <td class="dataField" colspan="3">
                                                <mcs:MCSSelectControl ID="select_Promotor" runat="server" PageUrl="~/SubModule/PM/Search_SelectPromotor.aspx"
                                                    Width="400px" />
                                            </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <td>
                                                            <table cellpadding="0" cellspacing="0" width="100%" border="0" class="h3Row" height="29px">
                                                                <tr>
                                                                    ...
                                                                    <td align="right">
                                                                        MAC地址：<asp:TextBox ID="tbx_MACAddr" runat="server" Width="200px"></asp:TextBox>&nbsp;<asp:Button
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <mcs:UC_GridView ID="gv_MACAddrList" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                DataKeyNames="ID" OnRowDeleting="gv_MACAddrList_RowDeleting">
                                                                <Columns>
