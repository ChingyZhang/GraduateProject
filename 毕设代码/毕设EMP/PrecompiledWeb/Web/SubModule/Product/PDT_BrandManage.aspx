<%@ page language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" stylesheettheme="basic" autoeventwireup="true" inherits="SubModule_Product_PDT_BrandManage, App_Web_r43usu2p" enableEventValidation="false" %>
                    ...
                    <td>
                        <mcs:UC_GridView ID="ud_grid" runat="server" PanelCode="Panel_PDT_List_003" PageSize="10"
                            ...
                            <Columns>
                                ...
                                <asp:CommandField ShowEditButton="true" EditText="包含的分类" ControlStyle-CssClass="listViewTdLinkS1" />
                            </Columns>
                        </mcs:UC_GridView>
                    </td>
                </tr>
