<%@ page language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" stylesheettheme="basic" autoeventwireup="true" inherits="SubModule_Product_PromotionalProductList, App_Web_r43usu2p" enableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" class="moduleTitle">
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    分类：<asp:DropDownList ID="ddl_Classify" runat="server" AutoPostBack="True" DataTextField="Name"
                                        DataValueField="ID" OnSelectedIndexChanged="ddl_Classify_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    子分类：<asp:DropDownList ID="ddl_cxptype2" runat="server" DataTextField="Name" DataValueField="ID">
                                    </asp:DropDownList>
                                    <%--开始时间：<asp:TextBox ID="tbx_StartDate" runat="server" onfocus="setday(this);"></asp:TextBox>
                                    结束时间：<asp:TextBox ID="tbx_EndDate" runat="server" onfocus="setday(this);"></asp:TextBox>
                                    <br />--%>
                                    段位：<asp:DropDownList ID="ddl_Grade" runat="server" DataTextField="Value" DataValueField="Key">
                                    </asp:DropDownList>
                ...
                <tr>
                    <td valign="top">
                        <mcs:UC_GridView ID="ud_grid" runat="server" PanelCode="Panel_PDT_List_006" AllowPaging="True"
                            AutoGenerateColumns="False" Width="100%" DataKeyNames="PDT_Product_ID" PageSize="15">
                            <Columns>
                                <asp:HyperLinkField DataNavigateUrlFields="PDT_Product_ID" DataNavigateUrlFormatString="ProductDetail.aspx?ID={0}&IsOpponent=9"
