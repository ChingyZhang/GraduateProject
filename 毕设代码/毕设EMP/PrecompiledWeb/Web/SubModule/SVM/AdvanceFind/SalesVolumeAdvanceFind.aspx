<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_SVM_AdvanceFind_SalesVolumeAdvanceFind, App_Web_bugljaha" enableEventValidation="false" stylesheettheme="basic" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
        ...
        <tr class="tabForm" runat="server" id="tr_AdvancedSearch">
            <td>
                <uc1:AdvancedSearch ID="AdvancedSearch1" runat="server" PanelCode="Panel_SVM_AdvanceFind_SalesVolumeAdvanceFind" />
            </td>
        </tr>
    </table>
</asp:Content>
