<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_SVM_JXCSummary_Detail, App_Web_yabmfp6z" enableEventValidation="false" stylesheettheme="basic" %>
                                ...
                                <td>
                                    <mcs:UC_GridView ID="gv_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Product,FactoryPrice,SalesPrice,RetailPrice"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="期初库存(上月截止20日实物库存结转)" SortExpression="BeginningInventory">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="21-20日ERP发货(以发运日期为准)" SortExpression="PurchaseVolume">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="21-20日客户实物到库签收(含上一会计月在途本月实物到库)" SortExpression="SignInVolume">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label2" runat="server" Text='<%# GetJXCData((int)Eval("Product"),(int)Eval("SignInVolume"),(decimal)Eval("FactoryPrice"),(decimal)Eval("SalesPrice"),(decimal)Eval("RetailPrice")).ToString("0.##")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>                                          
                                            ...
                                            <asp:TemplateField HeaderText="经销商销售出库" SortExpression="SalesVolume" ItemStyle-ForeColor="Blue"
                                            ...
                                            <asp:TemplateField HeaderText="退回公司" SortExpression="ReturnedVolume">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="盘存盈(+)亏(-)" SortExpression="StaleInventory">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="调货-调入" SortExpression="TransferInVolume">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="调货-调出" SortExpression="TransferOutVolume">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="经销商20日实物库存" SortExpression="ComputInventory" ItemStyle-ForeColor="#993300"
                                             ...
                                             <asp:TemplateField HeaderText="期末在途(截止20日)"   SortExpression="TransitInventory" ItemStyle-ForeColor="#993300" HeaderStyle-ForeColor="#993300">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label9" runat="server" Text='<%# GetJXCData((int)Eval("Product"),(int)Eval("TransitInventory"),(decimal)Eval("FactoryPrice"),(decimal)Eval("SalesPrice"),(decimal)Eval("RetailPrice")).ToString("0.##")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="账面库存"   SortExpression="PaperInventory" ItemStyle-ForeColor="#993300" HeaderStyle-ForeColor="#993300">
                                                <ItemTemplate>
