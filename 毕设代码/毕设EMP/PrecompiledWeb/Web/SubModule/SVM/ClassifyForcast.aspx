<%@ page language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_SVM_SalesForcast, App_Web_yabmfp6z" enableEventValidation="false" stylesheettheme="basic" %>
                            ...
                            <tr>
                                <td>
                                    <mcs:UC_GridView ID="gv_List" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        PanelCode="Panel_SVM_ClassifyForcast_1" DataKeyNames="SVM_ClassifyForcast_ID"
                                        ...
                                        <Columns>
                                            <asp:TemplateField ItemStyle-Width="20px">
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chk_ID" runat="server" Visible='<%#  DataBinder.Eval(Container,"DataItem.SVM_ClassifyForcast_ApproveFlag").ToString()=="未审核"%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:HyperLinkField Text="查看详细" DataNavigateUrlFields="SVM_ClassifyForcast_ID" DataNavigateUrlFormatString="ClassifyForcastDetail.aspx?ForcastID={0}"
                                                ControlStyle-CssClass="listViewTdLinkS1" ItemStyle-Width="80px" >
                                            </asp:HyperLinkField>
                                            <asp:TemplateField HeaderText="预估额(元)">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label2" runat="server" Text='<%# GetForcastSumPrice(DataBinder.Eval(Container,"DataItem.SVM_ClassifyForcast_ID").ToString()) %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="审批记录">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="view" runat="server" NavigateUrl='<%# "~/SubModule/EWF/TaskDetail.aspx?TaskID="+DataBinder.Eval(Container,"DataItem.SVM_ClassifyForcast_TaskID").ToString()%>'
                                                         Text='审批记录' Visible='<%# DataBinder.Eval(Container,"DataItem.SVM_ClassifyForcast_TaskID").ToString()!="0" %>'
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gv_Summary" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ShowFooter="false">
                                        <Columns>
                                            <asp:BoundField DataField="Classify" HeaderText="品项分类" SortExpression="Classify" />
                                            <asp:BoundField DataField="SumAmount" HeaderText="合计金额" SortExpression="SumAmount"
