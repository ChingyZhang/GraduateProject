<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_SVM_MYSaleInFlagSummary, App_Web_yabmfp6z" enableEventValidation="false" stylesheettheme="basic" %>
                            ...
                            <tr class="tabForm">
                                <td>
                                    ...
                                    <mcs:UC_GridView ID="gv_ListDetail" runat="server" Width="100%"  GridLines="Both"  AutoGenerateColumns="true" AllowPaging="true" PageSize="30" 
                                     BorderWidth="1px"  EnableViewState="false" onpageindexchanging="gv_ListDetail_PageIndexChanging" >
                                        <Columns>
