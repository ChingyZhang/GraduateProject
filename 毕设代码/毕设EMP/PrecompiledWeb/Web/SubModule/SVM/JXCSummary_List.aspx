<%@ page title="" language="C#" masterpagefile="~/MasterPage/BasicMasterPage.master" autoeventwireup="true" inherits="SubModule_SVM_JXCSummary_List, App_Web_yabmfp6z" enableEventValidation="false" stylesheettheme="basic" %>
                                    ...
                                    <mcs:UC_GridView ID="gv_List" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ClientTypeName" HeaderText="客户类型" SortExpression="ClientTypeName"
                                                Visible="false" />
                                            <asp:BoundField DataField="BeginningInventory" HeaderText="期初库存(上月截止20日实物库存结转)" SortExpression="BeginningInventory"
                                                DataFormatString="{0:0.##}" />
                                            <asp:BoundField DataField="PurchaseVolume" HeaderText="21-20日ERP发货(以发运日期为准)" SortExpression="PurchaseVolume"
                                                DataFormatString="{0:0.##}" />
                                             <asp:BoundField DataField="SignInVolume" HeaderText="21-20日客户实物到库签收(含上一会计月在途本月实物到库)" SortExpression="SignInVolume"
                                                DataFormatString="{0:0.##}" />                                          
                                            ...
                                            <asp:BoundField DataField="SalesVolume" HeaderText="经销商销售出库" SortExpression="SalesVolume"
                                            ...
                                            <asp:BoundField DataField="ReturnedVolume" HeaderText="退回公司" SortExpression="ReturnedVolume"
                                                DataFormatString="{0:0.##}" />
                                            <asp:BoundField DataField="StaleInventory" HeaderText="盘存盈(+)亏(-)" SortExpression="StaleInventory"
                                                DataFormatString="{0:0.##}" />
                                            <asp:BoundField DataField="TransferInVolume" HeaderText="调货-调入" SortExpression="TransferInVolume"
                                                DataFormatString="{0:0.##}" />
                                            <asp:BoundField DataField="TransferOutVolume" HeaderText="调货-调出" SortExpression="TransferOutVolume"
                                                DataFormatString="{0:0.##}" />
                                            ...
                                            <asp:BoundField DataField="ComputInventory" HeaderText="经销商20日实物库存" SortExpression="ComputInventory"
                                                DataFormatString="{0:0.##}" ItemStyle-ForeColor="#993300" HeaderStyle-ForeColor="#993300">
                                                <HeaderStyle ForeColor="#993300" />
                                                <ItemStyle ForeColor="#993300" />
                                            </asp:BoundField>
                                              <asp:BoundField DataField="TransitInventory" HeaderText="期末在途(截止20日)" SortExpression="TransitInventory"
                                                DataFormatString="{0:0.##}" />
