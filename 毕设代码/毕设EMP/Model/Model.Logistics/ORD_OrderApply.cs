...
namespace MCSFramework.Model.Logistics
{
    ...
    /// </summary>
    [Serializable]
    public class ORD_OrderApply : IModel
    {
        #region 私有变量定义
        private int _id = 0;
        ...
        ///
        ///</summary>
        public ORD_OrderApply(int id, string sheetcode, int accountmonth, int organizecity, int publishid, int client, int state, int type, DateTime prearrivaldate, int approveflag, DateTime inserttime, int insertstaff, DateTime updatetime, int updatestaff)
        {
            _id = id;
