...
namespace MCSFramework.Model.CM
{
	...
	public class CM_WareHouse : IModel
	{
		...
		///
		///</summary>
		public CM_WareHouse(int id, int client, string code, string name, int officialcity, string address, string telenum, int area, string keeper, string mobile, decimal longitude, decimal latitude, int activestate, string remark, int approvetask, int approveflag, DateTime inserttime, int insertstaff, DateTime updatetime, int updatestaff)
		{
			_id           = id;
			_client       = client;
			_code         = code;
