...
namespace MCSFramework.Model.CM
{
	...
	public class CM_KPI : IModel
	{
		...
		///
		///</summary>
		public CM_KPI(int id, int client, int accountmonth, decimal totalscore, int approveflag, DateTime inserttime, int insertstaff, DateTime updatetime, int updatestaff)
		{
			_id           = id;
			_client       = client;
            ...
            set 
			{
				switch (FieldName)
                {
					...
					case "AccountMonth":
						...
						break;
					case "TotalScore":
						decimal.TryParse(value, out _totalscore);
						break;
					case "ApproveFlag":
