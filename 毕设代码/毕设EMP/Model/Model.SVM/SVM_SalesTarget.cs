...
{
	/// <summary>
	///SVM_SalesTarget数据实体类
	/// </summary>
	[Serializable]
	public class SVM_SalesTarget : IModel
	{
		#region 私有变量定义
		private int _id = 0;
		...
		///
		///</summary>
		public SVM_SalesTarget(int id, int accountmonth, int organizecity, int client, int approveflag, DateTime inserttime, int insertstaff, DateTime updatetime, int updatestaff)
		{
			_id           = id;
