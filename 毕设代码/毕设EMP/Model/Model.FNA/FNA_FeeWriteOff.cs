...
{
    /// <summary>
    ///FNA_FeeWriteOff数据实体类
    /// </summary>
    [Serializable]
    public class FNA_FeeWriteOff : IModel
    {
        #region 私有变量定义
        private int _id = 0;
        ...
        private int _insteadpayclient = 0;
        ...
        ///
        ///</summary>
        public FNA_FeeWriteOff(int id, string sheetcode, int organizecity, int accountmonth, int feetype, int state, int approveflag, DateTime inserttime, int insertstaff, DateTime updatetime, int updatestaff)
        {
            _id = id;
        ...
        /// 费用代垫经销商
        /// </summary>
        public int InsteadPayClient
        {
            get { return _insteadpayclient; }
            set { _insteadpayclient = value; }
        }
        ///<summary>
        ///报销单状态
        ///</summary>
        ...
        public string this[string FieldName]
        {
            get
            {
                switch (FieldName)
                {
                    ...
                    case "InsteadPayClient":
                        return _insteadpayclient.ToString();
                    case "State":
            ...
            set
            {
                switch (FieldName)
                {
                    ...
                    case "FeeType":
                        ...
                        break;
                    case "InsteadPayClient":
                        int.TryParse(value, out _insteadpayclient);
                        break;
                    case "State":
