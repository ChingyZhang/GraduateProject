...
{
    /// <summary>
    ///FNA_FeeApplyDetail数据实体类
    /// </summary>
    [Serializable]
    public class FNA_FeeApplyDetail : IModel
    {
        #region 私有变量定义
        private int _id = 0;
        ...
        ///
        ///</summary>
        public FNA_FeeApplyDetail(int id, int applyid, int client, int accounttitle, decimal applycost, decimal adjustcost, string adjustreason, int flag, int beginmonth, int endmonth, DateTime begindate, DateTime enddate, string remark, decimal availcost)
        {
            _id = id;
            _applyid = applyid;
            _client = client;
        ...
        /// 关联品牌
        /// </summary>
        public string RelateBrands = "";

        public string ModelName
        {
            get { return "FNA_FeeApplyDetail"; }
        }
        #region 索引器访问
