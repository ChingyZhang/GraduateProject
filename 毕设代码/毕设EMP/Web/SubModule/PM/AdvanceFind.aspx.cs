...
public partial class SubModule_PM_AdvanceFind : System.Web.UI.Page
{
    ...
    protected void as_uc_promotor_OnSelectedChanging(object sender, AdvancedSearch_OnSelectedChangingEventArgs e)
    {
        int _id = (int)e.SelectedRowDataKey[0];

        Response.Redirect("PM_PromotorDetail.aspx?PromotorID=" + _id.ToString());
    }
}
