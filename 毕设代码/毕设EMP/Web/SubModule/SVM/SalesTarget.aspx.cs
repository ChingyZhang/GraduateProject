...
public partial class SubModule_SVM_SalesTarget : System.Web.UI.Page
{
    ...
    private void BindDropDown()
    {
        ...
        ddl_EndMonth.SelectedValue = AC_AccountMonthBLL.GetMonthByDate(DateTime.Now.AddMonths(3)).ToString();
    ...
    {
        if (select_Client.SelectValue != "")
            Response.Redirect("SalesTargetDetail.aspx?ClientID=" + select_Client.SelectValue + "&ClientType=" + ViewState["ClientType"].ToString());
        else
            Response.Redirect("SalesTargetDetail.aspx?ClientType=" + ViewState["ClientType"].ToString());
    }
